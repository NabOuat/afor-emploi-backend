...
from app.models import ZoneDIntervention, TRegion, TDepartement, TSousPrefecture, Users
...
async def get_zones_by_projects(projet_ids: str, acteur_id: str, db: Session = Depends(get_db), _: Users = Depends(get_current_user)):
    """
